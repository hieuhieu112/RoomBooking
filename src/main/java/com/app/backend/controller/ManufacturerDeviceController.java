...
@RestController
@RequestMapping("/manufacturerdevices")
@AllArgsConstructor
public class ManufacturerDeviceController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<DataResponse<ManufacturerDeviceResponse>> getById(@PathVariable Integer id) {
    ...
    @GetMapping
    public ResponseEntity<DataResponse<List<ManufacturerDeviceResponse>>> getAll() {
        DataResponse<List<ManufacturerDeviceResponse>> response = DataResponse.<List<ManufacturerDeviceResponse>>builder()
