...
public class RoleController {
    ...
    @PostMapping
    public ResponseEntity<DataResponse<RoleResponse>> create(@Valid @RequestBody RoleRequest request, BindingResult result) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<DataResponse<RoleResponse>> update(@PathVariable Integer id, @Valid @RequestBody RoleRequest request, BindingResult result) {
        ValidRequestUtil.validateRequest(result);
        DataResponse<RoleResponse> response = DataResponse.<RoleResponse>builder()
